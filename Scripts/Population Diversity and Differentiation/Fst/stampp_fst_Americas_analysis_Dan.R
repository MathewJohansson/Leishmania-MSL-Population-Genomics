...
save(fst_results, fst_matrix, pval_matrix,
     file = "Data/Fst/tetraploid_fst_AM_results_robust.RData")
...
ggsave("Figures/Fst/fst_heatmap_AM_tetraploid.jpeg",
...
ggsave("Figures/Fst/fst_boxplot_AM_tetraploid.jpeg",
...
ggsave("Figures/Fst/fst_AM2_comparison_barplot.jpeg",
...
ggsave("Figures/Fst/fst_combined_figure_AM_chr31.jpeg",
