...
# Output: Figures/Phylogenetics Work/NJ Trees/Whole-Genome/L. infantum-only/
...
OUT_DIR  <- file.path(BASE_DIR, "Figures/Phylogenetics Work/NJ Trees/Whole-Genome/L. infantum-only")
DATA_OUT <- file.path(BASE_DIR, "Data/Phylogenetic_Data/Whole-Genome/L.infantum-only")
...
pop_membership <- read_tsv(file.path(BASE_DIR, "scripting/population_membership_table_infantum_only_k13_LI_notation.tsv"))

ldonovani_to_exclude <- c("ERR3550127", "ERR205758")
outliers_to_remove   <- c("ERR205787", "SRR8608748", ldonovani_to_exclude)

# Named Paul Tol palette — LI notation (K=13)
...
print(paste("Removed outliers + L. donovani. New sample count:", nrow(dosage_imputed)))
...
stamppPhylip(nei_dist_matrix,
             file = file.path(DATA_OUT, "diploid_whole_genome_Linfantum_only_Neis_distance.txt"))

nj_tree <- nj(as.dist(nei_dist_matrix))
write.tree(nj_tree, file = file.path(DATA_OUT, "diploid_whole_genome_Linfantum_only_Neis_tree.nwk"))
save.image(file.path(DATA_OUT, "diploid_whole_genome_Linfantum_only_Neis.RData"))
...
## 8. PLOT: MSL STATUS (panel A of D2.3) ---------------------------------------
...
ggsave(file.path(OUT_DIR, "diploid_whole_genome_Linfantum_only_NJ_tree_msl.jpeg"),
       plot = nj_plot.msl, width = 10, height = 10, dpi = 300)




## 9. PLOT: POPULATION (panel B of D2.3) ---------------------------------------
...
ggsave(file.path(OUT_DIR, "diploid_whole_genome_Linfantum_only_NJ_tree_population.jpeg"),
...
ggsave(file.path(OUT_DIR, "diploid_whole_genome_Linfantum_only_NJ_tree_msl_populations.jpeg"),
       plot = nj_plot.msl.populations, width = 20, height = 10, dpi = 300)




## 10. PLOT: MSL0-ONLY BY POPULATION (D2.4) ------------------------------------
...
ggsave(file.path(OUT_DIR, "diploid_whole_genome_Linfantum_only_NJ_tree_MSL0_Only.jpeg"),
       plot = nj_plot_msl0_pops, width = 12, height = 10, dpi = 300)




## 11. PLOT: BY COUNTRY (D2.1) -------------------------------------------------
...
ggsave(file.path(OUT_DIR, "diploid_whole_genome_Linfantum_only_NJ_tree_country.jpeg"),
       plot = nj_plot_country, width = 20, height = 20, dpi = 300)




## 12. PLOT: BY REGION (D2.2) --------------------------------------------------
...
ggsave(file.path(OUT_DIR, "diploid_whole_genome_Linfantum_only_NJ_tree_region.jpeg"),
