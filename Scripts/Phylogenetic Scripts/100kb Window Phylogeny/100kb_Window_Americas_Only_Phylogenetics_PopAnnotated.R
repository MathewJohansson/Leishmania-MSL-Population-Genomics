...
# 100kb WINDOW PHYLOGENY — Americas-only
...
FIGURES_DIR  <- file.path(BASE_DIR, "Figures/Phylogenetics Work/100kb Windows/Americas-Only")
OUTPUTS_DIR  <- file.path(BASE_DIR, "Phylogeny Outputs/100kb Windows/Americas_Only")
...
metadata_americas       <- metadata %>% filter(source_geographic_region == "Americas")
...
ggsave(file.path(FIGURES_DIR, "By Country",
                 "Americas_only_100kb_circular_tree_by_country_with_host_and_cnv_popannotated.jpeg"),
       plot = americas_only_100kb_circular_tree_by_country_with_host_and_cnv,
       width = 25, height = 25, units = "in", dpi = 600)

ggsave(file.path(FIGURES_DIR, "By Country",
                 "Americas_only_100kb_circular_tree_by_country_with_host_and_cnv_popannotated.pdf"),
       plot = americas_only_100kb_circular_tree_by_country_with_host_and_cnv,
       width = 25, height = 25, units = "in", dpi = 600)
...
americas_only_100kb_rectangular_tree_by_country_with_host_and_cnv <- rectangular_tree +
  ...
  ggtitle("Rectangular L. infantum Phylogeny (100kb MSL Window)\nAmerican Strains Only, with Host Origin, CNV Coverage, and ADMIXTURE Population")
...
ggsave(file.path(FIGURES_DIR, "By Country",
                 "Americas_only_100kb_rectangular_tree_by_country_with_host_and_cnv_popannotated.jpeg"),
...
ggsave(file.path(FIGURES_DIR, "By Country",
                 "Americas_only_100kb_rectangular_tree_by_country_with_host_and_cnv_popannotated.pdf"),
       plot = americas_only_100kb_rectangular_tree_by_country_with_host_and_cnv,
       width = 25, height = 80, units = "in", dpi = 300, limitsize = FALSE)
