...
FIGURES_DIR  <- file.path(BASE_DIR, "Figures/Phylogenetics Work/20kb Windows/L.infantum-Only")
OUTPUTS_DIR  <- file.path(BASE_DIR, "Phylogeny Outputs/20kb Windows/Linfantum_Only")
...
ggsave(file.path(FIGURES_DIR, "By Country",
                 "Linfantum_Only_20kb_circular_tree_by_country_with_host_and_cnv_popannotated.jpeg"),
       plot = linfantum_20kb_circular_tree_by_country_with_host_and_cnv,
       width = 25, height = 25, units = "in", dpi = 600)

ggsave(file.path(FIGURES_DIR, "By Country",
                 "Linfantum_Only_20kb_circular_tree_by_country_with_host_and_cnv_popannotated.pdf"),
       plot = linfantum_20kb_circular_tree_by_country_with_host_and_cnv,
       width = 25, height = 25, units = "in", dpi = 600)
...
ggsave(file.path(FIGURES_DIR, "By Region",
                 "Linfantum_Only_20kb_circular_tree_by_region_with_host_and_cnv_popannotated.jpeg"),
       plot = linfantum_20kb_circular_tree_by_region_with_host_and_cnv,
       width = 25, height = 25, units = "in", dpi = 600)

ggsave(file.path(FIGURES_DIR, "By Region",
                 "Linfantum_Only_20kb_circular_tree_by_region_with_host_and_cnv_popannotated.pdf"),
       plot = linfantum_20kb_circular_tree_by_region_with_host_and_cnv,
       width = 25, height = 25, units = "in", dpi = 600)
...
ggsave(file.path(FIGURES_DIR, "By Country",
                 "Linfantum_Only_20kb_rectangular_tree_by_country_with_host_and_cnv_popannotated.jpeg"),
       plot = linfantum_20kb_rectangular_tree_by_country_with_host_and_cnv,
       width = 35, height = 80, units = "in", dpi = 300, limitsize = FALSE)

ggsave(file.path(FIGURES_DIR, "By Country",
                 "Linfantum_Only_20kb_rectangular_tree_by_country_with_host_and_cnv_popannotated.pdf"),
       plot = linfantum_20kb_rectangular_tree_by_country_with_host_and_cnv,
       width = 35, height = 80, units = "in", dpi = 300, limitsize = FALSE)
...
ggsave(file.path(FIGURES_DIR, "By Region",
                 "Linfantum_Only_20kb_rectangular_tree_by_region_with_host_and_cnv_popannotated.jpeg"),
       plot = linfantum_20kb_rectangular_tree_by_region_with_host_and_cnv,
       width = 30, height = 80, units = "in", dpi = 300, limitsize = FALSE)

ggsave(file.path(FIGURES_DIR, "By Region",
                 "Linfantum_Only_20kb_rectangular_tree_by_region_with_host_and_cnv_popannotated.pdf"),
       plot = linfantum_20kb_rectangular_tree_by_region_with_host_and_cnv,
       width = 30, height = 80, units = "in", dpi = 300, limitsize = FALSE)
